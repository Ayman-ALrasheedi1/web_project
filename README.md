...
​Luxury Garage is a web-based platform designed for car enthusiasts to explore premium car modification products and custom vehicle builds. The site acts as a digital showroom, bridging the gap between a physical shop and the online community by allowing users to browse high-performance parts and gain inspiration for their own projects anytime.  
...
​User & Admin Roles: Secure authentication system with different interfaces for customers and administrators. Admins have exclusive access to add/delete products and manage customer messages.  
...
​Products.php: Searchable catalog with filtering options.  
​Builds.php: Portfolio of completed projects.  
​Messages.php: Admin-side dashboard for handling customer inquiries. 
